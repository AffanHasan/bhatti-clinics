...
["common_data_lib", "common-data-lib.dart", , R, {
  "^": "",
  main: [function() {
    var req, t1;
    req = new XMLHttpRequest();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(req, C.EventStreamProvider_readystatechange._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure(req)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
...
//# sourceMappingURL=common-data-lib.dart.js.map
{
  var message =
